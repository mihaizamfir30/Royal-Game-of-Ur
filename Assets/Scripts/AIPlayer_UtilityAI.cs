...
public class AIPlayer_UtilityAI : AIPlayer {
	...
	float aggressivenessBonus = 0.25f; // Gets added for bops and removed for staying on safe places
	...
	virtual protected float GetStoneGoodness(PlayerStone stone, Tile currentTile, Tile futureTile) {
		float goodness = Random.Range (-0.1f, 0.1f); // Add a little noise
		...
		// TODO: Remove goodness for tiles that are in a "danger zone" and are more likely to get you bopped
		// TODO: Add goodness for tiles in our private sidelines
